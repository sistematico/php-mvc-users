        ...
        <div class="row justify-content-md-center">
            <div class="col-5">
                ...
                <form class="form-signin" action="<?php echo URL; ?>users/login" method="post">
                    ...
                    <input name="email" type="text" id="email" class="form-control mb-3" placeholder="Email or login" required autofocus>
                    <label for="inputPassword" class="sr-only">Password</label>
                    <input name="password" type="password" id="password" class="form-control" placeholder="Password" aria-describedby="passwordHelp" required>
