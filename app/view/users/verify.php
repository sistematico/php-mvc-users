<main role="main" class="container">
    ...
    <form class="form-inline" action="<?php echo URL; ?>users/verify" method="post">
        <div class="form-group mb-2 mr-2">
            ...
            <input name="verify" type="text" class="form-control" id="verify" placeholder="Verification Code" value="" <?php echo (isset($code) && $code[1] == 'sucessful' ? 'disabled' : 'required'); ?> />
        </div>
        <button name="submit_verify_user" type="submit" class="btn btn-primary mb-2" <?php echo (isset($code) && $code[1] == 'sucessful' ? 'disabled' : ''); ?>>Verify</button>
    </form>
</main>
