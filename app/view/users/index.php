        ...
        <tbody>
            <?php foreach ($users as $user) { ?>
                <tr>
                    ...
                    <td onload="unixTimestamp();"><?php echo (isset($user->created) ? $user->created : 'n/a'); ?></td>
                    <td onload="unixTimestamp();"><?php echo (isset($user->access) ? $user->access : 'n/a'); ?></td>
                    <td>
                        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') { ?>
                            ...
                            <a href="<?php echo URL . 'users/validate/' . htmlspecialchars($user->id, ENT_QUOTES, 'UTF-8'); ?>"><i class="fas fa-check"></i></a>
