<main role="main" class="container">
    ...
    <form class="form-inline" action="<?php echo URL; ?>users/update" method="post">
        ...
        <div class="form-group mb-2 mr-2">
            ...
            <input name="email" type="text" class="form-control" id="email" placeholder="E-mail" value="<?php echo isset($user['email']) ? htmlspecialchars($user['email'], ENT_QUOTES, 'UTF-8') : ''; ?>" required />
        </div>
        <div class="form-group mb-2 mr-2">
